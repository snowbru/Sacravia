...
(() => {
  ...
  const VOYAGES = [
    ...
    { id: 'sainte-baume', titre: 'Sainte”baume', pays: 'France', theme: ['madeleine', 'montagne'], duree: '2j', jours: 2, prix: 160, devise: 'EUR', resume: "Grotte Ste”Marie”Madeleine, forêt relique et crête.", img: 'https://images.unsplash.com/photo-1507692049790-de58290a4334?w=800', dates: ['2025-03-29', '2025-05-17', '2025-09-20'], tags: ['Var', 'Grotte', 'Forêt'] },
